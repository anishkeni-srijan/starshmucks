...
gethomeappbar() {
  return AppBar(
    ...
    title: Text(
      'Starschmucks',
      style: TextStyle(color: HexColor("#175244"), fontWeight: FontWeight.w600),
    ),
    elevation: 5,
    actions: [
      IconButton(
...
getbanner(context, username) {
  return Container(
    ...
    child: Column(
      children: [
        Container(transform: Matrix4.translationValues(0, 28, 0),child: Text('Hi '+ username + '!', style: TextStyle(color: Colors.white, fontSize: 20), ),),
        Container(
          ...
          child: Row(
            children: [
              Container(
                  ...
                  child: Image.asset('images/stars.png', width: 20,) ),
              Column(
                children: [
                  AutoSizeText(
                    '1/5',
              ...
              Container(
                  ...
                  transform: Matrix4.translationValues(30, 4, 0),
                  child: AutoSizeText(
        ...
        Container(
          ...
          child: Stack(
            children: [
              ...
              Container(
                child: Container(
                  transform: Matrix4.translationValues(105, 10, 0),
                  child: Text(
              ...
              Container(
                transform: Matrix4.translationValues(105, 40, 0),
                child: Text(
                  'A Schtarry Decade',
                  style: TextStyle(
                      color: Colors.white,
              ...
              Container(
                transform: Matrix4.translationValues(180, 80, 0),
                child: TextButton(
                    onPressed: () {},
        ...
        Container(
          ...
          child: Stack(
            children: [
              ...
              Container(
                child: Container(
                  transform: Matrix4.translationValues(145, 20, 0),
                  child: Text(
                    'Buy 2,',
                    style: TextStyle(color: Colors.white, fontSize: 15),
                  ),
              ...
              Container(
                transform: Matrix4.translationValues(145, 40, 0),
                child: Text(
                  'For the Price of 1.',
                  style: TextStyle(
                      color: Colors.white,
        ...
        Container(
          ...
          child: Stack(
            children: [
              ...
              Container(
                child: Container(
                  transform: Matrix4.translationValues(120, 20, 0),
                  child: Text(
                    'Lorem Ipsum',
                    style: TextStyle(color: Colors.white, fontSize: 15),
                  ),
              ...
              Container(
                transform: Matrix4.translationValues(120, 40, 0),
                child: AutoSizeText(
            ...
            children: [
              ...
              Container(
                child: Container(
                  child: Text(
                    'Learn More',
                    style: TextStyle(color: HexColor('#175244'), fontSize: 15,fontWeight: FontWeight.w600),
                  ),
                ),
              ),
              Container(
